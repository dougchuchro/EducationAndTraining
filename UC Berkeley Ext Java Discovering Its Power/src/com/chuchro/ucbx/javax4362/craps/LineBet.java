...
public abstract class LineBet extends Bet {
	...
	/** All Line bet types has a $5 minimum.														*/
	public static int	MIN_AMOUNT = 5;
	/** Line bets can be any amount greater than minimum, less than maximum							*/
	public static int	AMOUNT_MULTIPLE = 1;
	/** Payout ratio for all Line bets is 1:1														*/
	public static double	PAYOUT_RATIO = 1/1;
	/** List of winning come out rolls for a line bet.												*/
	public static List<Integer> COME_OUT_LINE_BET_WINNERS	= new ArrayList<Integer>(Arrays.asList(7,11));
	/** List of losing come out rolls for a line bet.												*/
	public static List<Integer> COME_OUT_LINE_BET_LOSERS	= new ArrayList<Integer>(Arrays.asList(2,3,12));
	/** List of rolls that establish the point for a line bet.										*/
	 ...
	 * @param betName
	 * @param maxAmt																				 */
	LineBet(String betName, int maxAmt) {
		super(betName, MIN_AMOUNT, maxAmt, AMOUNT_MULTIPLE);
	...
	/**
	 * Abstract method requires implementing classes to define their own OddsBet, specifically
	 ...
	 * @return result	If the bet was a winner, the amount won, plus the amount of the associated Odds bet, 
	 * 					if there is one.															*/
	...
	/**
	 * Return a message with the details of the associated Odds bet.
	 * @return	The Odds bet details message														*/
